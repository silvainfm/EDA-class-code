...
```
Though we have not done it in full detail here, let's assume we have shown that AGE does not appear to be conditional on fave_fruit or weekly_groceries. 
