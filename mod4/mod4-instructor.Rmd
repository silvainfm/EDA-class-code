...
# write a comment to explain each line of code
finalPlot <- ggplot(airquality_temp, aes(x = month_cat, y = Ozone, fill = relative_temp)) +
                geom_boxplot(alpha=0.7) +
                scale_y_continuous(
                    breaks = seq(0, 175, 25),
                    limits=c(0, 175)) +
                scale_fill_brewer(palette = "Accent") +
                labs(title="Ozone Quality During Summer Months") +
                xlab("Month") +
                ylab("Ozone in\nparts per billion") +
