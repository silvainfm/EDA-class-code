...
Note: An important feature of these plots is the meaningfulness of the vertical axis: No gaps are inserted between the strata, so the total height of the plot reflects the cumulative quantity of the observations.
...
ggplot(flows, aes(y = count, axis1 = Origin, axis2 = Dest)) +
  ...
  geom_stratum(width = 1/12, fill = "black", color = "grey") +
  geom_label(stat = "stratum", aes(label = after_stat(stratum))) + 
  labs(title = "Most Common Flight Paths by Airline from Houston in 2011", y='Number of flights') + 
  scale_fill_manual(values = c("blue", "darkorange", "grey")) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) + 
  guides(fill = guide_legend(title = "Airline"))
# add labs for title and y axis title, take out x axis 
