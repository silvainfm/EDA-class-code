...
gg_miss_var(airquality, facet = month_cat, show_pct = TRUE)+
...
Then TALK THROUGH / DISCUSS the code below:
...
matrixplot(airquality, sortby = "Ozone")
```
